...
public class AddTimePackageAmountTest extends AbstractComponentTest {
    ...
    @Test
    void shouldAddTimeToTimePackage() throws IOException, InterruptedException {
        ...
        int expectedAmount = createdTimePackage.amount() + timePackageSaveRequest.amount();
